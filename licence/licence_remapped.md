...
- *Making money ANY other way? → Extended (royalty on FlexUp-Based
Revenues)*
...
of the Licence, depending on the nature and extent of their use.
...
2.1. Capitalised terms within this Contract are Defined Terms, whose
definitions are given in the table below or, if not here, elsewhere in
the Contract or in the FlexUp Glossary (available on
www.flexup.org/glossary).

2.2. In case of any terminological discrepancies between the documents
forming this Contract, the Defined Terms should be interpreted according
to the document priority indicated in the Special Conditions. Where no
Licence-SC has been executed, the Licence-GC shall prevail.

2.3. The present FlexUp Licence-GC is distributed by FlexUp under the
following terms and can be found on the FlexUp website
([[www.flexup.org]{custom-style="Hyperlink"}](http://www.flexup.org))

+----------+-----------------------------------------------------------+
| Defined  | Definition                                                |
| Term     |                                                           |
+==========+===========================================================+
| **       | FlexUp, a Subaccount of Cosys S.C., a Société civile,     |
| FlexUp** | with a share capital of 100 005 €, registered at 10 rue   |
|          | Saint Paul, under the RCS of Paris with number 519 072    |
...
|          | Material, including the terms of the Licence-GC and, if   |
|          | applicable, the Licence-SC.                               |
+----------+-----------------------------------------------------------+
| **Lice   | This document outlining the general terms and conditions  |
| nce-GC** | for use of the Licensed Material.                         |
| or       |                                                           |
| *        |                                                           |
| *General |                                                           |
| Cond     |                                                           |
...
| itions** | conjunction.                                              |
+----------+-----------------------------------------------------------+
| **       | All documents, templates, software, data models,          |
| Licensed | methodologies and any other materials developed or        |
| Ma       | published by FlexUp, whether made available through its   |
| terial** | websites                                                  |
|          | ([[www.flex                                               |
|          | up.org]{custom-style="Hyperlink"}](http://www.flexup.org) |
|          | and                                                       |
|          | [[www.flexup                                              |
|          | .app]{custom-style="Hyperlink"}](http://www.flexup.app)), |
|          | the FlexUp Platform or App, or any other official         |
|          | channel. It includes all associated content, interfaces,  |
|          | algorithms, and updates that refer to or are governed by  |
|          | this FlexUp Licence, including any future versions or     |
|          | updates released by FlexUp.                               |
+----------+-----------------------------------------------------------+
| **Li     | Any person or entity who obtains the right to use the     |
| censee** | Licensed Material under this Licence, whether by          |
...
direct party;
b) To structure or manage a single project or business in which the
Licensee holds a key position (e.g., owner, director, majority
shareholder);
c) For internal use within a single organization or company, as the
Licensee, including use by its officers, employees and authorised agents
...
Licence. If any revenue or other financial benefit is generated from
such distribution, whether direct or indirect, and regardless of the
monetisation mechanism (including but not limited to advertising,
...
fair use of this Licence.
    ...
    materials, or other deliverables for third parties.
...
the Licensee\'s financial records for the sole purpose to ensure
compliance with the terms of this Licence. Audits shall be conducted at
FlexUp\'s expense, unless the audit reveals a discrepancy exceeding five
percent (5%) in FlexUp\'s favour, in which case the Licensee shall bear
...
Licence;
b) Payment of all applicable royalties retroactively from the first day of
*effective* Extended Use; and
c) Application of a late payment penalty of twenty per cent (20%) on any
overdue royalties.
1.3. FlexUp reserves the right to seek compensation for any further
losses or damages suffered as a result of such breach, including,
without limitation, any loss of commercial opportunity, competitive
disadvantage, and harm to its reputation or expenses incurred in
connection with the breach or its enforcement.
...
calendar quarter.
b) Upon receipt of such report, FlexUp shall issue a Proforma Accounting
Document to the Licensee. The Licensee agrees to pay the full invoiced
amount via bank transfer.
c) If the invoice is received by the Licensee before the 15th of a given
month, payment is due at the end of that same month. If the invoice is
received after the 15th of a given month, payment is due at the end of
the following month.
d) De minimis rule: Where FlexUp-Based Revenue arising from a given
activity is less than 1 000 € per calendar quarter, such revenue shall
...
b) If the Licensee still fails to pay within fifteen (15) days after
receipt of a written request from FlexUp, then an additional penalty of
ten percent (10%) of the overdue amount plus interest accruing daily at
an annual rate of ten percent (10%).
c) FlexUp may at its own discretion and without prejudice to any other
rights or remedies suspend further provision of services until payment
in full is received or terminate this agreement.

### Article 3. Flexibility and Good-Faith Adjustment

3.1. FlexUp recognises that some Licensees, particularly small
organisations, independent professionals or early-stage initiatives, may
temporarily be unable to sustain the standard royalty rate defined in
Article 8. In such cases, FlexUp remains open to discussing alterative
arrangements in good faith, with the objective of preserving
collaboration and fairness in order to uphold the Parties' mutual
interests and long-term viability.

3.2. Licensees who wish to request a deferral or alternative form of
contribution shall contact FlexUp within thirty (30) days of the due
date of the applicable royalty. Any adjusted term shall be agreed in
writing and may be formalised through the Licence-SC.

3.3. This mechanism does not, by any means, waive the Licensee's
obligation to report usage but allows both Parties to adapt the
financial terms to the Licensee's actual circumstances.

3.4. FlexUp operates on a principle of trust. We believe our users will
fairly assess and report their usage. Disputes will be resolved through
discussion before any formal proceedings.

### Article 4. Open Source Principles and Obligations
...
exercising any rights granted under this Licence.

4.6. The Licensee may recover only reasonable and direct costs incurred
in duplicating, reproducing, transmitting or hosting the Materials. No
licence fee, royalty or other charge may be imposed for the Materials
themselves. Any sums recovered shall reflect cost recovery only and not
constitute consideration for intellectual property rights.

4.7. The Licensee may offer for sale or otherwise charge for products or
services that use, implement, or incorporate the Materials. Where such
activity exceeds the scope of Limited Use, the provisions for Extended
Licence and the applicable royalty obligations in Article 8 (Payment and
...
6.1. FlexUp is not a law firm, accounting firm, tax consultancy,
financial advisory firm, or any other regulated professional service
provider.

6.2. The Licensed Material is provided on an \"as-is\" and "as
available" basis without any express or implied warranty, including but
not limited to warranties of accuracy, fitness for a particular purpose,
or non-infringement. The use of the Licensed Material is entirely at the
user\'s own risk and does not create any fiduciary, or other
professional relationship between FlexUp and the Licensee.

6.3. FlexUp makes no warranty as to the conformity of the Licensed
Material with local laws, regulations, accounting standards, tax
requirements or any other statutory, regulatory or professional
obligations that may apply in any jurisdiction.

6.4. To the maximum extent permitted by law, FlexUp, its affiliates,
contributors and licensors shall not be liable for any direct, indirect,
incidental, special, consequential or punitive damages, including loss
of profits, data, goodwill or business interruption, arising from or in
connection with the use of the Licensed Material, including reliance on
any information contained therein.

6.5. Licensees are strongly encouraged to obtain independent
professional advice before applying or relying upon the Licensed
Material in any context involving legal, accounting, financial,
regulatory, technical or other professional considerations that may give
rise to liability or compliance requirements.

### Article 7. Updates and Revisions

7.1. FlexUp reserves the right to modify the FlexUp Licence at any time
and to publish new versions. Licensees are encouraged to check its
official website for updates regularly.

7.2. The updated version of the FlexUp Licence shall automatically apply
to this Licence 30 days after publication, unless otherwise stated.

7.3. Licensees are encouraged to subscribe to the FlexUp newsletter to
be informed of any updates to the FlexUp Licence.
...
b) Infringes or misuses FlexUp intellectual property, trademarks or
copyrights;
c) Engages in any conduct that, in FlexUp's reasonable opinion, damages its
reputation or the integrity of the Licensed Material;
...
documents to which the Licensee is a party.
c) All rights granted to the Licensee under this Licence shall immediately
terminate.
d) The Licensee must, upon request from FlexUp, certify in writing that
they have complied with the obligations in this section.
...
9.1. By using the Licensed Material, Licensees acknowledge that they
...
9.3. If the Parties have executed a Licence-SC ("Special Conditions"),
such Special Conditions shall complement these General Conditions and,
in case of any conflict, exception, or deviation, the previsions of the
...
Use. These examples are for guidance only and do not replace the
definitions and terms contained in Articles 4 and 5 of this Licence.
{.Normal-(Web)}

  ---------------------------------------------------------------------------
  **Role / Activity**    **Permitted   **Examples / Notes**
                         Under**       
  ---------------------- ------------- --------------------------------------
  Founder / Business     Limited       Using FlexUp Charters, templates, or
  Owner                                models internally for their own
                                       company or project.

  Lawyer / Legal Advisor Limited       Providing advice to **one (1) single**
                                       client in any rolling 12-month period,
                                       including review or adaptation of
                                       FlexUp templates for that client.

  Lawyer / Legal Advisor Extended      Advising **two (2) or more** clients
                                       using FlexUp materials, models, or
                                       templates; generates Extended Use and
                                       potential royalty obligations.

  Accountant / Financial Limited       Applying a FlexUp cost model or
  Advisor                              template for **one (1) client** only,
                                       or using FlexUp tools internally for a
                                       single assignment.

  Accountant / Financial Extended      Managing accounts, bookkeeping,
  Advisor                              reporting, or financial structures for
                                       **multiple clients** using FlexUp
                                       materials or workflows.

  Consultant / Business  Extended      Offering FlexUp-based consulting,
  Analyst                              dashboards, analyses, governance
                                       materials, or operational services to
                                       **two (2) or more** clients**.**

  Project Manager /      Limited       Using FlexUp tools or templates
  Employee                             internally for their employer.

  Developer / Software   Extended      Integrating elements of the FlexUp
  Integrator                           Model into custom software,
                                       automations, or dashboards delivered
                                       to a client (**one** company or
                                       project).

  Developer / Software   Platform      Integrating the FlexUp Model into a
  Integrator (Platform   Agreement     multi-tenant, public-facing, or
  Use)                   Required      commercial SaaS platform; this
                                       requires a Platform Agreement in
                                       addition to Extended Licence.

  Educator / Trainer     Limited       Referencing FlexUp concepts as part of
  (general use)                        a broader academic or non-commercial
                                       curriculum where FlexUp is not the
                                       core of the course.

  Educator / Trainer     Extended      Providing paid workshops, tutorials,
  (specific use)                       courses, or training materials that
                                       focus on FlexUp or use FlexUp content
                                       as a key component.

  Inclusion in a Paid    Extended      Embedding parts of the FlexUp Model
  App / SaaS Tool                      into proprietary software that is
                                       sold, licensed, or used to generate
                                       revenue for clients.

  Blog Series /          Extended      Republishing, translating, or adapting
  Publication with Ads                 FlexUp documentation (or substantial
                                       parts of it) in a website or channel
                                       that generates income (ads,
...
portion of the advisory services related to implementing FlexUp account
for **20%** of the value provided; the remaining 80% relates to
unrelated advisory work (such as market research on the client's
products).\
→ FlexUp-Based Revenue = 10 000 € × 20% = **2 000**\
→ Royalty due = 10% × 2 000 € = **200 €**

**Example 2 --- Single Client, Multiple Deliverables**\
A legal advisor invoices a client **1 800 €** for corporate structuring
advice, 700 € of which is directly based on FlexUp templates, while the
rest is bespoke drafting work.\
→ FlexUp-Based Revenue = 700 €\
→ Royalty due = 10% × 700 € = **70 €**\
→ If the quarterly royalty is below 100 €, the **de minimis rule
applies** (annual reporting) unless the Advisor exceeds 1 000 € in
FlexUp-Based Revenue that quarter.

**Example 3 --- Training or Workshops**\
A trainer charges **3 000 €** for a one-day workshop. FlexUp material
represents approximately half of the course content.\
